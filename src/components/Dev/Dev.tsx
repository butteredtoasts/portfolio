    ...
    <>
      <div className="devBox">
        ...
        <p className="devBody">
          ...
          believe it should be used to express yourself through whatever medium
          including web design. Once this website is feature-complete I will
          consider adding more animations and photos that show off who I am.
        </p>
        ...
        <p className="devBody">
          ...
          using IntelliJ as an IDE and Gradle to build the application.
          <br></br>
          <br></br>
          ...
          documentation, and more. Check out my GitHub in the Contact tab to see
          the code.
          <br></br>
          <br></br>
          ...
          in my mod. Each food has at least seven unique textures when counting
          the growth stage textures!
        </p>
        <br></br>
